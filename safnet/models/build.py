...
from safnet.models.pn2.pn2ssg import PN2SSG
from safnet.models.unet_resnet34 import UNetResNet34
#from safnet.models.mvpnet_3d_late_fusion_attention import MVPNet3D
from safnet.models.mvpnet_3d_late_fusion_attention_linear_mapping import MVPNet3D
#from safnet.models.mvpnet_3d_late_fusion_attention_original import MVPNet3D
#from safnet.models.mvpnet_3d_0603 import MVPNet3D
# from safnet.models.mvpnet_3d_early_fusion import MVPNet3D
...
def build_model_mvpnet_3d(similarity,cfg):
    ...
    model = MVPNet3D(similarity,model_2d, cfg.MODEL_2D.CKPT_PATH, model_3d, **cfg.FEAT_AGGR)
    loss_fn = model.get_loss(cfg)
    train_metric, val_metric = model.get_metric(cfg)
    return model, loss_fn, train_metric, val_metric
