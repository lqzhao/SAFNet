...
from safnet.models.build import build_model_sem_seg_3d
from safnet.data.scannet_3d import ScanNet3D
from safnet.data import transforms as T
    ...
    with torch.no_grad():
        ...
        for scan_idx in range(len(test_dataset)):
            ...
            for indices in chunk_indices:
                ...
                #     from safnet.utils.o3d_util import visualize_point_cloud
...
def main():
    ...
    from safnet.config.sem_seg_3d import cfg
